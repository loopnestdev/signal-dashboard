...
+---------------------------------------------------------------------------+
|  WATCHLIST  [Default]  [AI-MEM x]  [+ New list]                           |
|  [Search ticker...]  [Analyze -->]    AAPL x  NVDA x                          |
|                                                                           |
|  +- SIGNA.AI SIGNAL --------------------------------------------------+   |
|  |  ● BULLISH  Grade A  Stage 3 - Mark-up  87% conf.  Risk: Low       |   |
|  |  ^ Nightly 30+ model pipeline - matches Signa Canvas Action Card   |   |
|  |  WEEKLY (1W)  ● BULLISH  Grade A  87% conf.  [OK] Aligned             |   |
|  |  ENTRY $181.00  STOP $174.50  TARGET $198.00  2.3x                 |   |
...
|  |  --> SPY above all major MAs  [OK] Breadth expanding  [WARN] FOMC in 3d      |   |
|  +--------------------------------------------------------------------+   |
+---------------------------------------------------------------------------+
```
